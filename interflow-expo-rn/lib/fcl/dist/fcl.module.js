...
function _getChainIdFromAccessNode() {
  _getChainIdFromAccessNode = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response;
...
function _setChainIdDefault() {
  _setChainIdDefault = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var network;
...
function _getChainId() {
  _getChainId = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var network;
...
function _execStrategyData() {
  _execStrategyData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref3) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          _context2.t3 = _objectSpread({}, config.client);
          _context2.t4 = {};
...
function _execService() {
  _execService = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(_ref4) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          _context3.t3 = _objectSpread({}, config.client);
          _context3.t4 = {};
      ...
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 5:
          ...
          log({
            ...
            message: "Check fcl.accountProof.resolver configuration.\n                Expected: fcl.accountProof.resolver: async () => { ... }\n                Received: fcl.accountProof.resolver: ".concat(_typeof(accountProofDataResolver), "\n                "),
            level: LEVELS.warn
          });
          return _context8.abrupt("return");
        case 8:
...
function _getStrategyData() {
  _getStrategyData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
...
function _authorization() {
  _authorization = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(account) {
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        case 0:
          spawnCurrentUser();
          return _context14.abrupt("return", _objectSpread(_objectSpread({}, account), {}, {
            tempId: "CURRENT_USER",
...
function _resolveArgument() {
  _resolveArgument = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee16() {
    ...
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        ...
        case 2:
          ...
          return _context16.abrupt("return", arg(withPrefix(addr), t$1.Address));
        case 5:
        case "end":
...
function _signUserMessage() {
  _signUserMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17(msg) {
...
function getTemplateMessage(_ref) {
  ...
  invariant$1(_typeof(template) === "object", "getTemplateMessage({ template }) -- template must be an object");
...
function getTemplateArgumentMessage(_ref) {
  ...
  invariant$1(_typeof(template) === "object", "getTemplateArgumentMessage({ template }) -- template must be an object");
...
export { index$1 as AppUtils, index as InteractionTemplateUtils, VERSION, index$2 as WalletUtils, authenticate, authz, currentUser, discovery, events, getChainId, getStrategyData, logIn, mutate, pluginRegistry, query, reauthenticate, serialize, signUp, t, transaction as tx, unauthenticate, verifyUserSignatures };
