      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 14:
            ...
            _iterator = _createForOfIteratorHelper__default["default"](getContractIdentifierSyntaxMatches(cadence));
            _context.prev = 16;
          ...
          case 18:
            ...
            _step$value = _slicedToArray__default["default"](_step.value, 2), fullMatch = _step$value[0], contractName = _step$value[1];
            _context.next = 22;
            return config.config().get("system.contracts.".concat(contractName));

          case 22:
            address = _context.sent;

            if (address) {
              cadence = cadence.replace(fullMatch, "import ".concat(contractName, " from ").concat(utilAddress.withPrefix(address)));
            } else {
