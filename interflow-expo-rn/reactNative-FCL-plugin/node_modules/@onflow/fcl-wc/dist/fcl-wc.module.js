      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            invariant(CONFIGURED_NETWORK === "mainnet" || CONFIGURED_NETWORK === "testnet", "FCL Configuration value for 'flow.network' is required (testnet || mainnet)");
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 16:
                ...
                data = JSON.stringify(_objectSpread(_objectSpread({}, body), {}, {
                  addr: addr,
                  address: address
                }));
                _context2.prev = 20;
...
function _connectWc() {
  _connectWc = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(_ref6) {
...
function _makeWcServices() {
  _makeWcServices = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(_ref7) {
...
export { init };
//# sourceMappingURL=fcl-wc.module.js.map
