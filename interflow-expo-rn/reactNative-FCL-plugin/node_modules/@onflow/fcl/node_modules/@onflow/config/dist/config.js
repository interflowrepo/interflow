  ...
  if (isObject$1(target) && isObject$1(source)) {
    for (var key in source) {
      if (isObject$1(source[key])) {
        if (!target[key]) Object.assign(target, _defineProperty__default["default"]({}, key, {}));
...
var mergeFlowJSONs$1 = function mergeFlowJSONs(value) {
  return Array.isArray(value) ? mergeDeep$1.apply(void 0, [{}].concat(_toConsumableArray__default["default"](value))) : value;
};
/**
...
var HANDLERS$1 = (_HANDLERS$1 = {}, _defineProperty__default["default"](_HANDLERS$1, PUT$1, function (ctx, _letter, _ref) {
  var key = _ref.key,
      value = _ref.value;
  if (key == null) throw new Error("Missing 'key' for config/put.");
  ctx.put(key, value);
  ctx.broadcast(UPDATED$1, _objectSpread__default["default"]({}, ctx.all()));
}), _defineProperty__default["default"](_HANDLERS$1, GET$1, function (ctx, letter, _ref2) {
  var key = _ref2.key,
      fallback = _ref2.fallback;
  if (key == null) throw new Error("Missing 'key' for config/get");
  letter.reply(ctx.get(key, fallback));
}), _defineProperty__default["default"](_HANDLERS$1, GET_ALL$1, function (ctx, letter) {
  letter.reply(_objectSpread__default["default"]({}, ctx.all()));
}), _defineProperty__default["default"](_HANDLERS$1, UPDATE$1, function (ctx, letter, _ref3) {
  var key = _ref3.key,
      fn = _ref3.fn;
  if (key == null) throw new Error("Missing 'key' for config/update");
  ctx.update(key, fn || identity$1);
  ctx.broadcast(UPDATED$1, _objectSpread__default["default"]({}, ctx.all()));
}), _defineProperty__default["default"](_HANDLERS$1, DELETE$1, function (ctx, letter, _ref4) {
  var key = _ref4.key;
  if (key == null) throw new Error("Missing 'key' for config/delete");
  ctx["delete"](key);
  ctx.broadcast(UPDATED$1, _objectSpread__default["default"]({}, ctx.all()));
}), _defineProperty__default["default"](_HANDLERS$1, CLEAR$1, function (ctx, letter) {
  ...
  ctx.broadcast(UPDATED$1, _objectSpread__default["default"]({}, ctx.all()));
}), _defineProperty__default["default"](_HANDLERS$1, WHERE$1, function (ctx, letter, _ref5) {
...
utilActor.spawn(HANDLERS$1, NAME$1);

function put$1(key, value) {
  utilActor.send(NAME$1, PUT$1, {
    key: key,
    value: value
  });
  return config$1();
...
function get$1(key, fallback) {
  return utilActor.send(NAME$1, GET$1, {
    key: key,
    fallback: fallback
  }, {
    expectReply: true,
...
function _first$1() {
  _first$1 = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2() {
    var wants,
        fallback,
        _wants,
        head,
...
function all$1() {
  return utilActor.send(NAME$1, GET_ALL$1, null, {
    expectReply: true,
    timeout: 10
  });
}
...
function update$1(key) {
  ...
  utilActor.send(NAME$1, UPDATE$1, {
    key: key,
    fn: fn
  });
  return config$1();
...
function _delete$1(key) {
  utilActor.send(NAME$1, DELETE$1, {
    key: key
  });
  return config$1();
}
...
function where$1(pattern) {
  return utilActor.send(NAME$1, WHERE$1, {
    pattern: pattern
  }, {
    expectReply: true,
    timeout: 10
...
function subscribe$1(callback) {
  return utilActor.subscriber(NAME$1, function () {
    return utilActor.spawn(HANDLERS$1, NAME$1);
  }, callback);
}

function clearConfig$1() {
  return utilActor.send(NAME$1, CLEAR$1);
}
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 13:
            ...
            _Object$entries$_i = _slicedToArray__default["default"](_Object$entries[_i2], 2), key = _Object$entries$_i[0], value = _Object$entries$_i[1];
...
var mergeFlowJSONs = function mergeFlowJSONs(value) {
  return Array.isArray(value) ? mergeDeep.apply(void 0, [{}].concat(_toConsumableArray__default["default"](value))) : value;
};
/**
 * Filter out contracts section of flow.json.
 * @param {Object|Object[]} obj
